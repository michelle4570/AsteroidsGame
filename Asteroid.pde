class Asteroid extends Floater // don't stop array at list.size() because there's no set size,stop at ~20
{
  ...
  public Asteroid(){
    ...
    myColor = color((int)(Math.random()*25)+159,(int)(Math.random()*25)+159,(int)(Math.random()*20)+159);
  ...
  public void move(){
    turn(rotSpeed);
    super.move();class Asteroid extends Floater // don't stop array at list.size() because there's no set size,stop at ~20
{
  protected double rotSpeed;
  public Asteroid(){
    rotSpeed = (int)(Math.random()*10)-5;
    ...
    myCenterX = (int)(Math.random()*600);
    myCenterY = (int)(Math.random()*600);
    myColor = color((int)(Math.random()*12)+155,(int)(Math.random()*25)+159,(int)(Math.random()*20)+159);
    myPointDirection = (int)(Math.random()*360);
    myXspeed=myYspeed = (int)(Math.random()*2)-1;
  }
  public void setXspeed(double x){
